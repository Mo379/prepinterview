...
var ActivationEmail = function ActivationEmail(_ref) {
  var firstName = _ref.firstName,
    activationLink = _ref.activationLink;
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(tailwind_1.Tailwind, null, /*#__PURE__*/React.createElement(components_1.Text, {
    ...
    className: "text-black text-[14px] leading-[24px]"
  }, "Please click on the link to confirm your account registration,"), /*#__PURE__*/React.createElement(components_1.Section, {
    className: "text-center mt-[32px] mb-[32px]"
  }, /*#__PURE__*/React.createElement(components_1.Button, {
    className: "bg-[#000000] rounded text-white text-[12px] font-semibold no-underline text-center px-5 py-3",
    href: activationLink
  }, "Activate Your Account")), /*#__PURE__*/React.createElement(components_1.Text, {
    className: "text-black text-[14px] leading-[24px]"
  ...
  }, activationLink))), /*#__PURE__*/React.createElement(components_1.Text, {
