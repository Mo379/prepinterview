...
const PasswordResetEmail = ({ firstName, userName, resetLink }) => {
    return (<>
            <tailwind_1.Tailwind>
                ...
                <components_1.Section className="text-center mt-[32px] mb-[32px]">
                    <components_1.Button className="bg-[#000000] rounded text-white text-[12px] font-semibold no-underline text-center px-5 py-3" href={resetLink}>
                        Reset Your Password
                    </components_1.Button>
                ...
                <components_1.Text className="text-black text-[14px] leading-[24px]">
                    ...
                    <components_1.Text className="text-black text-[14px] leading-[24px]">
                        <components_1.Link href={resetLink} className="text-blue-600 no-underline">
                            {resetLink}
                        </components_1.Link>
                    </components_1.Text>
                </components_1.Text>
